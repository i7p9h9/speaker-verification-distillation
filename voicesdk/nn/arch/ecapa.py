...
from ..layers import pooling as pooling_layers
...
class ECAPA_TDNN(nn.Module):
    ...
    def __init__(
        ...
        # self.spec = features.MelBanks(n_mels=feat_dim)

        self.spec = SpectralFeaturesTF(**features_cfg)

        self.layer1 = Conv1dReluBn(features_cfg["num_bins"], channels, kernel_size=5, padding=2)
