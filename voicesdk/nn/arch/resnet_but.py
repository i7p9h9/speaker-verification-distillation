'''ResNet in PyTorch.
https://github.com/phonexiaresearch/VBx-training-recipe/blob/main/local/models/resnet2.py
...
def ResNet18(feat_dim, embed_dim, squeeze_excitation=False):
    return ResNet(
        BasicBlock,
        [2, 2, 2, 2],
        feat_dim=feat_dim,
...
def ResNet34(feat_dim, embed_dim, squeeze_excitation=False):
    return ResNet(
        BasicBlock,
        [3, 4, 6, 3],
        feat_dim=feat_dim,
...
def ResNet34_MP(feat_dim, embed_dim, squeeze_excitation=False):
    return ResNet_MP(
        BasicBlock,
        [3, 4, 6, 3],
        feat_dim=feat_dim,
...
def ResNet50(feat_dim, embed_dim, squeeze_excitation=False):
    return ResNet(
        Bottleneck,
        [3, 4, 6, 3],
        feat_dim=feat_dim,
...
def ResNet152(feat_dim, embed_dim, squeeze_excitation=False):
    return ResNet(
        Bottleneck,
        [3, 8, 36, 3],
        feat_dim=feat_dim,
