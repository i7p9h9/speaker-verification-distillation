...
SUBNETWORK_CFG = "data/ckpt/rn100_tel4_vcd_subnet/config.json"
SUBNETWORK_CKPT = "data/ckpt/rn100_tel4_vcd_subnet/checkpoints/model_3.pt"
# STUDENT_CKPT = None
...
LOG_DIR = "data/exps/"
EXPERIMENT_NAME = "tel-subnet-emb-cosine-016"
...
def get_teacher() -> nn.Module:
    loader = SubnetworkLoader(
        teacher_cfg_path=TEACHER_CFG,
        teacher_ckpt_path=TEACHER_CKPT,
        subnet_config_path=SUBNETWORK_CFG,
        subnet_ckpt_path=SUBNETWORK_CKPT,
        subnet_ckpt_prefix="cls_head",
        probe_shape=(2, 1, 16000),
    )
...
def main() -> None:
    ...
    dataset_train_list = [
        ...
        WeightedDataset(
            dataset=VoxDataset(reader=reader_train, root=TRAIN_CODECS),
            weight=1.0
        )
    ]
